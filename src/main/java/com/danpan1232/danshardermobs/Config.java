...
@Mod.EventBusSubscriber(modid = danshardermobs.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config
{
    private static final ForgeConfigSpec.Builder BUILDER = new ForgeConfigSpec.Builder();

    public static final ForgeConfigSpec.BooleanValue DANSHARDERMOBS_MOB_SCALE_HEALTH = BUILDER
            .comment("Whether to modify mob health.")
            .define("mobScaleHealth", true);

    public static final ForgeConfigSpec.BooleanValue DANSHARDERMOBS_MOB_ARMOR = BUILDER
            .comment("Whether mobs can spawn with armor.")
            .define("mobArmor", true);

    public static final ForgeConfigSpec.BooleanValue DANSHARDERMOBS_MOB_EFFECTS = BUILDER
            .comment("Whether mobs can spawn with effects.")
            .define("mobEffects", true);

    public static final ForgeConfigSpec.BooleanValue DANSHARDERMOBS_MOB_WEAPONS = BUILDER
            .comment("Whether mobs can spawn with weapons. This does not affect vanilla behavior.")
            .define("mobWeapons", true);

    public static final ForgeConfigSpec.BooleanValue DANSHARDERMOBS_MOB_ENCHANTMENTS = BUILDER
            .comment("Whether mobs can spawn with enchanted equipment. This does not affect vanilla behavior.")
            .define("mobEnchantments", true);

    public static final ForgeConfigSpec.BooleanValue DANSHARDERMOBS_MOB_ILLEGAL_ENCHANTMENTS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue DANSHARDERMOBS_PLAYER_LEVEL_CAP = BUILDER
            .comment("Maximum level a player can attain.")
            .defineInRange("playerLevelCap", 35, 5, Integer.MAX_VALUE);

    public static final ForgeConfigSpec.IntValue DANSHARDERMOBS_PLAYER_SCALING_RANGE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_PERCENT_LOSE_LEVELS_DEATH = BUILDER
            .comment("Percent of current level amount of levels to lose on death.\n" +
                    "\n0: no levels lost" +
                    "\n1: lose all levels")
            .defineInRange("playerLoseLevelsDeath", 0.20, 0.0, 1);

    public static final ForgeConfigSpec.IntValue DANSHARDERMOBS_PLAYER_PERCENT_LOSE_LEVELS_DEATH_CAP = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_LOSE_LEVELS_MULTIPLIER = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue DANSHARDERMOBS_PLAYER_LOSE_LEVELS_CAP = BUILDER
            .comment("Maximum amount of levels to lose when scaling naturally.")
            .defineInRange("playerLoseLevelsCap", 35, 0, Integer.MAX_VALUE);

    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_VS_MOB_LEVEL = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue DANSHARDERMOBS_PLAYER_VS_MOB_LEVEL_CAP = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_Z_CLAMP = BUILDER
            .comment("Clamps the strength of gaining/losing levels upon kills.\n" +
                    "\nLower: more sensitive" +
                    "\nHigher: less sensitive")
            .defineInRange("playerZClamp", 2.0, 1, 5);

    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_Z_BIAS = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue DANSHARDERMOBS_PLAYER_EWMA_FACTOR = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_Z_CURVE_EXPONENT = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue DANSHARDERMOBS_PLAYER_VARIANCE_FLOOR = BUILDER
